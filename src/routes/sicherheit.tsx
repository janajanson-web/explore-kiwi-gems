...
const items = [
  ...
  { icon: Mountain, title: "Erdbeben & Vulkane", textNode: (<>Bei Beben: Drop, Cover, Hold. Aktuelle Lage auf <a href="https://www.geonet.org.nz" target="_blank" rel="noopener noreferrer" className="text-primary underline hover:text-accent">GeoNet</a> prüfen, besonders rund um Taupo und Ruapehu.</>) },
